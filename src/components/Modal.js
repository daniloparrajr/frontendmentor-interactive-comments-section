						...
						<div className="bg-white px-7 py-6 lg:p-8">
							...
							<div className="flex flex-wrap md:flex-nowrap">
								<button onClick={() => { setActive(!active); onHideModal(false); }}
										className="btn bg-grayish-blue px-5 w-full basis-full block mt-3 md:order-none md:mt-0 md:basis-auto md:mr-3 lg:mr-3.5 order-2">NO, CANCEL
								</button>
								<button onClick={onDeleteComment} className="btn bg-soft-red px-5 w-full basis-full block order-1 md:order-none md:basis-auto">YES,
									DELETE
								</button>
							</div>
						</div>
